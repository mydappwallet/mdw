...
class ContractInteration extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      more: false
    ...
    <React.Fragment>
                ...
                {this.props.transaction.value && 
                 ...
                 <Row className="border-bottom">
                    ...
                    <Col className="px-4 py-2 col-lg-9 col-sm-8 col-12"><Translate id={"network-" +network.name +"-name"}/></Col>
                  </Row>      
                 <Row className="border-bottom">
...
export default withLocalize(connect(mapStateToProps, mapDispatchToProps)(ContractInteration));

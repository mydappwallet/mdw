  ...
  render(){
    ...
    <React.Fragment>
                 ...
                 <Row className="border-bottom">
                  <Col className="px-4 py-2 col-lg-3 col-sm-3 col-12"><Translate id="userName"/></Col>
                  <Col className="px-4 py-2 col-lg-9 col-sm-9 col-12"><Translate id={this.props.transaction.username}/></Col>
                </Row>       
                <Row className="border-bottom">
                  <Col className="px-4 py-2 col-lg-3 col-sm-3 col-12"><Translate id="email"/></Col>
...
export default withLocalize(connect(mapStateToProps, mapDispatchToProps)(RegisterAccount));
